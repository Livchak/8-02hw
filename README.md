...
`проблемы с сборкой main.go`

1. `сборка не происходит не смотря на наличие файла main.go без понятия что там нужно копировать из Dockerfile`
2. `попытался собрать main.go вылетает ошибка не смотря на наличие файла`

**Скриншот 9** ls
<img src = "img/img-sborka-ls.jpg" width = 100%>


**Скриншот 10** ошибка
<img src = "img/img-sborka-fail.jpg" width = 100%>
